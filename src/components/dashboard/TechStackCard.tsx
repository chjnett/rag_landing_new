        ...
        <>
            <motion.div
                ...
                className={cn(
                    ...
                    "!bg-card/40 backdrop-blur-xl border-white/5 hover:border-primary/30 transition-all duration-300"
                )}
            >
                ...
                <div className="flex flex-wrap gap-1.5 mt-auto z-10">
                    {(stack.tags || []).map(tag => (
                        <span
                            key={tag}
                            className="text-[9px] font-bold px-2 py-0.5 bg-white/5 border border-white/10 rounded-md text-muted-foreground hover:text-foreground transition-all duration-300 hover:border-primary/30"
                        >
                            {tag}
                        </span>
                    ))}
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        >
                            <div className="flex items-center gap-6 mb-8">
                                ...
                                <div>
                                    <h2 className="text-3xl font-black tracking-tight">{stack.name}</h2>
                            ...
                            <motion.button
                                whileTap={{ scale: 0.95 }}
                                onClick={() => setIsExpOpen(false)}
                                className="mt-8 w-full py-3 rounded-xl bg-white/5 border border-white/10 text-xs font-bold hover:bg-white/10 transition-colors"
                            >
                                닫기
                            </motion.button>
